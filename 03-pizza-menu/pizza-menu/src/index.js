...
function Header(){
  ...
  <header className="header">
     <h1 style={style} >Fast React pizzeria</h1>
  </header>
  )
}
function Menu(){
   ...
   return (<main className="menu">
        ...
        {numPizzas >0 ? (
         <React.Fragment>
         <p>Authentic Italian pizza. 6 creative pizzas to choose from. All from our stone oven, all organic, all delicious.</p>
...
function Footer(){
  ...
  if(!isOpen) return <p>We're happy to welcome you between {openHour}:00 and {closedHour}:00</p>
...
function Order({closedHour, openHour}){
  ...
  return (<div className="order">
        <p>We're open from {openHour}:00 until {closedHour}:00. Come visit us or order online.</p>
